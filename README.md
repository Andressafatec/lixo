...
| :----: | :--------- | :----------------------------------------------------------------------------- | :----------- | :-----------: |
|01| Página Administrador | Como administrador quero ter acesso a todas as funcionalidades do sistema para conseguir ter acesso aos relatórios e aos perfis no qual consigo alterar o cargo deles. | média | RF 02 | O professor ainda não respondeu
|02| Como um executor quero poder responder a solicitação para que consiga aceitar ou rejeitar uma solicitação e em caso de rejeição é necessário colocar uma resposta  | alta | RF 03 | O professor ainda não respondeu
